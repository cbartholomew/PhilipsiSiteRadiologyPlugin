...
MethodSelect[MSi++] =  [0  ," - Select an iSite Enterprise method - "];
MethodSelect[MSi++] =  [0  ,""];
MethodSelect[MSi++] =  [0  ," - iSiteNonVisual Control Methods - "];
...
MethodSelect[MSi++] =  [48 ,"LockExam (lock an exam to prevent changes being made by other users)"];
MethodSelect[MSi++] =  [46 ,"Logout (logs the current user out)"];
MethodSelect[MSi++] =  [38 ,"MarkExamRead (mark an exam as read)"];
...
MethodSelect[MSi++] =  [57 ,"ShowDebugWindow (open the iSite Debug Window)"];
MethodSelect[MSi++] =  [103,"ShowiQueryWindow (Launches the iQuery Window)"];  
MethodSelect[MSi++] =  [0  ,""];
MethodSelect[MSi++] =  [0  ," - iSiteEnterprise Control Methods - "];
...
MethodSelect[MSi++] =  [35 ,"SetWindowView (sets zoom level and top left corner)"];   
MethodSelect[MSi++] =  [64 ,"ShowClinicalExamNotes (displays the clinical exam notes dialog)"];                                       
...
MethodSelect[MSi++] =  [100, "GetListOfKeyImages (Returns the ImageIDs of the Key Images)"];
MethodSelect[MSi++] =  [104, "GetPresentationStates (Returns the Presentation States)"];
MethodSelect[MSi++] =  [105, "CopyImageDataToClipboard (ShelfID, ImageID, Annotations, Overlays, JPEG) (Saves the image in a JPEG format.)"];
MethodSelect[MSi++] =  [106 ,"CreatePopupEx (creates a popup based on the navigation MonitorId, Window ID, xCo-ord, yCo-ord, Window Width, Window Height)"];
MethodSelect[MSi++] =  [107 ,"MessageBoxEx (displays a message box based on the MonitorID, message string, message type, xCo-ord, yCo-ord)"];                                                                   
MethodSelect[MSi++] =  [108 ,"GetAllMonitors (Returns an XML of the monitor information)"];                                                                   
